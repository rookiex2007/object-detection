...
def checkParkingSpace(imgPro):
    ...
    for pos in posList:
        ...
        cvzone.putTextRect(img, str(count),(x,y+height-5), scale=0.9,thickness=1,offset=0, colorR=color)
        
    cvzone.putTextRect(img, f"Free: {spaceCounter}/{len(posList)}",(100,50), scale=4,
